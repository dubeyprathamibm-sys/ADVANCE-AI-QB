...
Here’s a **6-mark structured answer key** for all 10 questions — written in a clear, simple, and student-friendly format 👇
...
* **1960s – Early Programs:** Development of early AI programs like *ELIZA (Chatbot)* and *SHRDLU (Language Understanding)*.
* **1970s–1980s – Expert Systems Era:** AI used in medical and industrial fields (e.g., *MYCIN*).
* **1990s – Machine Learning Boom:** Introduction of neural networks and data-driven learning.
* **2000s–Now – Modern AI:** Deep Learning, NLP, Robotics, ChatGPT, Self-driving cars, etc.
...
1. **Knowledge Base:**
   ...
   * Example: “If temperature > 102°F, then fever = yes.”
2. **Inference Engine:**
...
🧩 **Example:** Self-driving car adjusting speed automatically.
...
🧩 **Types of Primitive Acts (Concepts):**
...
**Answer:**
🎬 **Topic:** *“Going to the Doctor” Script*
